\documentclass[11pt,letterpaper,twosided]{report}
...
\usepackage[letterpaper,left=1.25in,top=1in,right=1in,bottom=1in,nohead]{geometry}
...
\begin{titlepage}
\newgeometry{left=1in,top=1.95in,right=1in,bottom=1in,nohead}
   \begin{singlespacing}
   \begin{center}
...
\newgeometry{left=1in,top=1.15in,right=1in,bottom=1in,nohead}
